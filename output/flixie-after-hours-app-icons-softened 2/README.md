...
The supplied pack is self-contained under `output/flixie-after-hours-app-icons-softened`. It has not been copied over the current native app resources. Installation is the folder merge/replacement above. Existing splash artwork is a separate branding surface and is not replaced by this icon pack.
