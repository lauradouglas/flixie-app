// Exact vector export of the approved After Hours concept. Requires sharp 0.34+.
const fs = require('node:fs');
const path = require('node:path');
const sharp = require('sharp');
const root = path.resolve(__dirname, '..');
const paths = ['M24 82V18H78V34H42V46H68V62H42V82Z', 'M54 70H78V82H54Z'];
...
(async()=>{
 ...
 board+=text(60,66,'FLIXIE / AFTER HOURS',25)+text(60,122,'App icon master & platform exports',42);
 ...
 board+=text(990,610,'LILAC  #B9A0FF',22)+text(990,651,'MIDNIGHT  #120A24',22)+text(990,718,'Exact vector geometry',18)+text(990,751,'Separate transparent foreground',18)+text(990,784,'Full-bleed store exports',18);
