...
class WatchlistActionsController {
  WatchlistActionsController({WatchlistActionsUseCase? useCase})
      : _useCase =
            useCase ?? WatchlistActionsUseCase(WatchlistRepositoryImpl());

  static final WatchlistActionsController instance =
  ...
  Future<void> deleteMovieWatch(String userId, String watchEntryId) =>
      _useCase.deleteMovieWatch(userId, watchEntryId);

  Future<List<MovieList>> getMyListsContainingMovie(
          String userId, int movieId) =>
      _useCase.getMyListsContainingMovie(userId, movieId);
